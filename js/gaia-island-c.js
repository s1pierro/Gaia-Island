...
$(window).on("load", function() {
	...
	$('body').on('click', '#btn-toggle-render-vb', function() {
		raztransformlayers();
		panrender = "VB";
		$('#btn-toggle-render-vb').replaceWith('<span id="btn-toggle-render-tl" class="jslink-a">render vb</span>');
		console.log('switch render to viewbox');
		refreshtransformlayers();
	});
	$('body').on('click', '#btn-toggle-render-tl', function() {
		panrender = "TL";
		$('#btn-toggle-render-tl').replaceWith('<span id="btn-toggle-render-vb" class="jslink-a">render tl</span>');
		raztransformlayers();
